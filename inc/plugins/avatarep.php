...
.tinner {
	...
	background:url(images/oyuncu/avatarep/loader.gif) no-repeat 50% 50% #FFFFFF;
...
.tclose {
	...
	height:30px;
	cursor:pointer;
	background:url(images/oyuncu/avatarep/close.png) no-repeat;
}
...
<script type="text/javascript" src="{$mybb->settings[\'bburl\']}/images/oyuncu/avatarep/avatarep.js"></script>');
...
function avatarep_deactivate() {
    ...
    //Reemplazos que vamos a hacer en las plantillas 1.- Platilla 2.- Contenido a Reemplazar 3.- Contenido que reemplaza lo anterior
	find_replace_templatesets("headerinclude", '#'.preg_quote('<script type="text/javascript" src="{$mybb->settings[\'bburl\']}/images/oyuncu/avatarep/avatarep.js"></script>').'#', '', 0);	
